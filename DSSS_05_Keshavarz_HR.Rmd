...
author: "Reinhold Kliegl & Hamid Keshavarz"
...
+ AOCQ: change attitudes of HR department (q01 to q18)
    + Subscale cognitive attitude (q01 to q06)
    + Subscale affective attitude (q07 to q12)
    + Subscale behavioral attitude (q13 to q18)

**Dependent variables**

+ Scale organizational innovation (q19 to q26; Counter Innovative Behavior, 1998)
+ Scale organizational staff happiness  (q27 to q49; Kjerulf, 2007)
    + Subscale learning (q27 to q30)
    + Subscale self-openness (q31 to q35)
    + Subscale participation (q36 to q38)
    + Subscale positive thinking (q39 to q42)
    + Subscale meaningful work (q43 to q45)
    + Subscale interesting work (q46 to q49)
...
_Solution_: Don't include `aff` now. Try to understand why male and female responded so differently.  Start over.
